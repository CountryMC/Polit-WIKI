...
<mark style="color:blue;">Модер</mark> — должность, члены которой специализируются на помощи игрокам, просмотр логов, решение тикетов, разборов ситуаций всех глав. Также имеют возможность проводить проверки на читы. Подчиняются РСА и TL. Имеет право на предложение изменения правил. Может выдавать предупреждения МСА.
...
<mark style="color:blue;">Мл. Модер</mark> — переходной уровень с должности МСА к ССА. Администратор должен знать правила сервера, понимать, как решать большинство вопросов, связанных с правилами сервера. Подчиняется РСА и TL. Имеет права на выдачу предупреждений МСА по согласованию с РСА или TL. Может внести изменение в правила.
...
<mark style="color:$success;">Мл. Хелпер</mark> — администратор, специализирующийся в основе на работе с чатом, слежкой за поведением игроков, а также ответах на вопросы. Подчиняется РСА и TL, следует указаниям ССА. Не может предлагать внести изменения в правила. Не имеет право выдавать и предлагать выдать предупреждение администрации.

<mark style="color:cyan;">Интерн</mark> — человек, находящийся на испытательном сроке, во время которого РСА смотрят за его работой и готовностью к повышению. Он подчиняется РСА и TL, следует указаниям ССА. Не может предлагать внести изменения в правила. Не имеет право выдавать и предлагать выдать предупреждение администрации.
