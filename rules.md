...
**Флуд** – часто повторяющиеся и одинаковые по смыслу, либо не имеющие смысловой нагрузки/бессодержательные сообщения. Интервал между такими сообщениями должен быть **не менее** **5 минут**
