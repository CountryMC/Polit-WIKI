...
<summary>Глава [5] : Нечестная игра<br><br>⛔️ <mark style="color:$warning;">Во время проверки можно делать запись экрана исключительно для личного пользование. Распространение и демонстрация(онлайн или записи) процесса проверки</mark> <mark style="color:$danger;">ЗАПРЕЩЕНО. В случае нарушения будет применено персональное наказание.</mark> </summary>
...
3. Запрещено пользоваться уязвимостями, которые дают преимущество, на ПВЕ ивентах\
   <mark style="color:blue;">**Возможность избежать наказание: Сообщить о баге администрации любыми возможными способами с ответной реакцией от администратора, к которому было обращение**</mark>\
   <mark style="color:red;">◦ Наказание: Кик. После 2-ух киков бан на 7 дней</mark>
...
### Линии работы администрации:

#### Общая администрация.

Стандартная ветка, которая занимается решением большинства тикетов и ситуаций на сервере. В состав общей администрации входит весь МСА-состав, младшие модераторы, модераторы, Тим Лид.

#### Ответвление войн.

Ветка, в которую может попасть администратор после хелпера. Вармастеры отличаются большим навыком в плане проверок, чем модераторы и младшие модераторы. Чтобы попасть в эту ветку, нужно согласовать попадание с Варлордом и сдать проведение проверки проверяющему с отличием.

## Иерархия:

#### <mark style="color:$danger;">Руководящий состав администрации (РСА)</mark>

<mark style="color:$danger;">**Администратор**</mark> — высшая администрация, может снимать/назначать администрацию, никому не подчиняется, имеет право изменять/добавлять правила и выдавать наказания игрокам по своему усмотрению, несмотря на правила.

<mark style="color:$danger;">**Куратор**</mark> — администратор, в подчинении которого стоит вся администрация проекта, подчиняется администратору, имеет право на изменение и добавление правил, может снимать и назначать администрацию.

#### <mark style="color:$warning;">Старший состав администрации (ССА)</mark>

<mark style="color:$warning;">**Тим Лид**</mark> — администратор, который занимается помощью в работе с основным составом администрации. Под его подчинением находятся МСА, младшие модераторы и модераторы. Имеет право на изменение, добавление правил на проект. Есть возможность на начисление предупреждений, а также выговоров должностям ниже своей. Не может снимать администраторов, но может предложить это сделать вышестоящему администратору.

<mark style="color:$warning;">**Варлорд**</mark> — отдельная должность, которая отвечает за управление отдела контроля войн и находится под руководством РСА. В полномочия Варлорда входит частичное управление МСА, а также полноценный контроль Вармастров и Вармаршелов. Он имеет право редактирования правил или добавления новых. Есть возможность выдавать наказание администраторов низшим должностям вплоть до выговора. Не имеет право снимать администраторов, но может предложить это сделать.

<mark style="color:$info;">**Вармаршал**</mark> — администратор занимается слежкой за рейдами. Ключевая специализация основывается на проведении проверок и слежке за нарушением правила пятой главы на высоком уровне. Администратор подчиняются РСА, Варлордам. Имеют возможность на изменение правил, а также выдавать предупреждения МСА.

<mark style="color:blue;">**Модер**</mark> — должность, члены которой специализируются на помощи игрокам, просмотр логов, решение тикетов, разборов ситуаций всех глав. Также имеют возможность проводить проверки на читы. Подчиняются РСА и ТЛ. Имеет право на предложение изменения правил. Может выдавать предупреждения МСА.

<mark style="color:$info;">**Вармастер**</mark> — начальная должность ветки, отвечающей за вары. Для попадания нужно пройти весь путь МСА, а также сдать проверку с отличием. Вармастеры занимаются проведением проверок и слежкой за игроками с целью пресечения нарушения правила в основе 5 главы.

<mark style="color:blue;">**Мл. Модер**</mark> — переходной уровень с должности МСА к ССА. Администратор должен знать правила сервера, понимать, как решать большинство вопросов, связанных с правилами сервера. Подчиняется РСА и ТЛ. Имеет права на выдачу предупреждений МСА по согласованию с РСА или ТЛ. Может внести изменение в правила.

#### <mark style="color:$success;">Младший состав администрации</mark>

<mark style="color:$success;">**Хелпер**</mark> — должность, которая отличается от прошлой только опытом и дополнительными правами. С этого момента администратор начинает готовиться к повышению и переходу в ССА. Подчиняется РСА и ТЛ. Может предложить изменения правил. Не имеет право выдавать и предлагать выдавать предупреждения администраторам.

<mark style="color:$success;">**Мл. Хелпер**</mark> — администратор, специализирующийся в основе на работе с чатом, слежкой за поведением игроков, а также ответах на вопросы. Подчиняется РСА и ТЛ, следует указаниям ССА. Не может предлагать внести изменения в правила. Не имеет право выдавать и предлагать выдать предупреждение администрации.

<mark style="color:cyan;">**Интерн**</mark> — человек, находящийся на испытательном сроке, во время которого РСА смотрят за его работой и готовностью к повышению. Он подчиняется РСА и ТЛ, следует указаниям ССА. Не может предлагать внести изменения в правила. Не имеет право выдавать и предлагать выдать предупреждение администрации.
