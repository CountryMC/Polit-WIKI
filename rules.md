...
15. Запрещено обходить АФК-систему (автоматические: движения, махание рукой, отправка сообщений в чат и тп, когда сам игрок находится не за устройством с которого он играет). Разрешено только полное бездействие (например для прогрузки автоферм и тп.)\
