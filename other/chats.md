...
## <mark style="color:$primary;">Виды чатов</mark>
...
* **`/ch room join <название_комнаты>`** - присоединиться к комнате, если она не приватная. Название комнаты - это ник ее создателя
...
## <mark style="color:$primary;">Чат-комната</mark>
...
* **`/ch room join <название_комнаты>`** - присоединиться к комнате
