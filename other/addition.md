...
Каждый день в **19:00МСК** на сервере случается **Армагедон**. В это время ПВП включено во всём мире и даже приват города не спасает от урона других игроков. **Армагедон** длится **30 минут**
