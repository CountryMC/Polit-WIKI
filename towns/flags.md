...
Флаги позволяют управлять различными возможностями на территории города, участка, группы участков или для участков конкретного жителя.
...
| Тип разрешения                   | Команды                                                     | Область действия                               |
| -------------------------------- | ----------------------------------------------------------- | ---------------------------------------------- |
...
{% hint style="info" %}
Приоритет всегда у флагов участа, если они заданы. Например если в городе <mark style="color:$success;">включен</mark> ПВП, а в участке <mark style="color:$danger;">выключен</mark>, то в итоге внутри участка ПВП будет <mark style="color:$danger;">выключен</mark>.
{% endhint %}

## <mark style="color:$primary;">Список флагов</mark>
