...
| **Государственный** | Может использоваться всеми жителями государства      | /plot set type Государственный |      **1**     |
...
| **Арена**           | Участок в котором включено ПВП                       | /plot set type Арена           |      **1**     |
