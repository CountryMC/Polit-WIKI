...
{% hint style="warning" %}
Захватывать можно только регионы, рядом с которым граничит хотя бы один захваченный регион. В начале войны, когда ни один регион еще не захвачен, сторона атака может начать захватывать только регионы, находящиеся по периметру защищающегося города.
{% endhint %}
