...
Начиная со **2 уровня** каждому городу автоматические выдаётся **7 дней** нейтралитета, который необходимо продлевать когда он подходит к концу или когда полностью истёк. Если время нейтралитета было просрочено и не продлено, любой город достигший **3 уровня** сможет объявить этому городу войну.

Следить за нейтралитетом можно в городском меню: **`/t`**

Продлить нейтралитет можно командой:

* **`/t neutrality`** - меню продления нейтралитета

Объявить войну можно командой:
...
Начиная с 3 уровня города любой город может предложить войну любому другому городу, достигшему 2 уровень. Война начинается если мэр города, которому была предложена война, согласится на это это предложение.

Объявить войну можно командой:

**`/t war declare offer <город>`** - объявить войну городу с просроченым нейтралитетом
